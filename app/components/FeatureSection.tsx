...
export default function FeatureSection() {
  return (
    <motion.section
      ...
      className="relative isolate overflow-hidden bg-[#d8d7ec] dark:bg-[#2d2c45]"
    >
      <Image
      ...
      <div className="absolute inset-0 bg-white/60 dark:bg-black/40 md:bg-transparent" />
        ...
        <div className="md:grid md:grid-cols-2 md:gap-16">
          <div>
            ...
            <motion.p
              variants={fadeUp}
              custom={1}
              className="mt-3 max-w-md text-gray-700 dark:text-gray-300"
            >
            ...
            <ul className="mt-12 space-y-10">
              {features.map(({ icon: Icon, title, description }, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold uppercase tracking-wide text-[var(--foreground)]">
                      {title}
                    </h3>
